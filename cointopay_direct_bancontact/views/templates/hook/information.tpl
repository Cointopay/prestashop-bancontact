...
<div id="Information" class="tabcontent">
	<div class="wrapper">
	  <img src="../modules/cointopay_direct_bancontact/views/img/invoice.png" style="float:right;"/>
	  <h2 class="cointopay-bancontact-information-header">Accept Bitcoin, Litecoin, Ethereum and other digital currencies on your PrestaShop store with Cointopay</h2><br/>
	  ...
	  <p>
	  	<ul>
	  		<li>Install the Cointopay Direct Bancontact module on PrestaShop</li>
	  ...
	  <img src="../modules/cointopay_direct_bancontact/views/img/currencies.png" style="float:right;"/>
	  <p class="sign-up"><br/>
